...
contract Company {
    ...
    function checkSufficientCCT(
        ...
        if (
            projects[projectId].cctSold + cctAmt > projects[projectId].cctAmount
        ) {
            //when buy, cctSold increases
            return false;
        }
        return true;
    }
    ...
    function sellCCT(
        ...
        projects[projectId].cctSold += cctAmt; //cctSold increases when buyer buys
    ...
    function checkCCTListed(
        ...
        if (
            ...
            projects[projectId].cctAmount
        ) {
            //when sell, cctListed increases
            return false;
        }
        return true;
    }
